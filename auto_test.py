#!/usr/bin/env python3
"""
hf2spdx-ai-bom_v1.8.py 的自動測試腳本
...
def test_hf2spdx_script(url, script_path="hf2spdx-ai-bom_v1.8.py", output_dir="./output_files/v1.8"):
...
def main():
    """執行自動測試的主函數"""
    print("hf2spdx-ai-bom_v1.8.py 自動測試")
    print("=" * 50)
    
    # 檢查主腳本是否存在
    script_path = "hf2spdx-ai-bom_v1.8.py"
