#!/usr/bin/env python3
"""
hf2spdx-ai-bom_v2.0.0.py 的自動測試腳本（已更新路徑）
...
def test_hf2spdx_script(url, script_path="src/hf2spdx_ai_bom.py", output_dir="./output/samples"):
...
def main():
    """執行自動測試的主函數"""
    print("hf2spdx-ai-bom 自動測試 (src/hf2spdx_ai_bom.py)")
    print("=" * 50)
    
    # 檢查主腳本是否存在
    script_path = "src/hf2spdx_ai_bom.py"
